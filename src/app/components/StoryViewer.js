...
const StoryViewer = () => {
  const { isStoryViewerOpen, activeStory, closeStoryViewer, deleteStory } =
    useFeed();
  ...
  const isVideo =
    activeStory.media.endsWith(".mp4") || activeStory.media.endsWith(".webm");
    ...
    >
      ...
      >
        ...
        <div className="absolute top-6 left-4 flex items-center z-10">
          <Image
            src={activeStory.user.profilePhoto || "/OSK.jpg"}
